...
let s:guiDiffAdd = s:mixcolors("090300", "01a252", 0.3)
let s:guiDiffDelete = s:mixcolors("090300", "db2d20")
let s:guiDiffChange = s:mixcolors("090300", "01a0e4", 0.3)
let s:guiDiffText = s:mixcolors("090300", "db2d20", 0.2)
