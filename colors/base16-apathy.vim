...
let s:guiDiffAdd = s:mixcolors("031A16", "883E96", 0.3)
let s:guiDiffDelete = s:mixcolors("031A16", "3E9688")
let s:guiDiffChange = s:mixcolors("031A16", "96883E", 0.3)
let s:guiDiffText = s:mixcolors("031A16", "3E9688", 0.2)
