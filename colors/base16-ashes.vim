...
let s:guiDiffAdd = s:mixcolors("1C2023", "95C7AE", 0.3)
let s:guiDiffDelete = s:mixcolors("1C2023", "C7AE95")
let s:guiDiffChange = s:mixcolors("1C2023", "AE95C7", 0.3)
let s:guiDiffText = s:mixcolors("1C2023", "C7AE95", 0.2)
