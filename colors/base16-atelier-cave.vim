...
let s:guiDiffAdd = s:mixcolors("19171c", "2a9292", 0.3)
let s:guiDiffDelete = s:mixcolors("19171c", "be4678")
let s:guiDiffChange = s:mixcolors("19171c", "576ddb", 0.3)
let s:guiDiffText = s:mixcolors("19171c", "be4678", 0.2)
