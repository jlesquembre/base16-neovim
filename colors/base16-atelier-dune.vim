...
let s:guiDiffAdd = s:mixcolors("20201d", "60ac39", 0.3)
let s:guiDiffDelete = s:mixcolors("20201d", "d73737")
let s:guiDiffChange = s:mixcolors("20201d", "6684e1", 0.3)
let s:guiDiffText = s:mixcolors("20201d", "d73737", 0.2)
