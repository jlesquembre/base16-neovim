...
let s:guiDiffAdd = s:mixcolors("22221b", "7d9726", 0.3)
let s:guiDiffDelete = s:mixcolors("22221b", "ba6236")
let s:guiDiffChange = s:mixcolors("22221b", "36a166", 0.3)
let s:guiDiffText = s:mixcolors("22221b", "ba6236", 0.2)
