...
let s:guiDiffAdd = s:mixcolors("1b1918", "7b9726", 0.3)
let s:guiDiffDelete = s:mixcolors("1b1918", "f22c40")
let s:guiDiffChange = s:mixcolors("1b1918", "407ee7", 0.3)
let s:guiDiffText = s:mixcolors("1b1918", "f22c40", 0.2)
