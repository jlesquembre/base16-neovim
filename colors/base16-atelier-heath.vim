...
let s:guiDiffAdd = s:mixcolors("1b181b", "918b3b", 0.3)
let s:guiDiffDelete = s:mixcolors("1b181b", "ca402b")
let s:guiDiffChange = s:mixcolors("1b181b", "516aec", 0.3)
let s:guiDiffText = s:mixcolors("1b181b", "ca402b", 0.2)
