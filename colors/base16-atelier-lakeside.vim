...
let s:guiDiffAdd = s:mixcolors("161b1d", "568c3b", 0.3)
let s:guiDiffDelete = s:mixcolors("161b1d", "d22d72")
let s:guiDiffChange = s:mixcolors("161b1d", "257fad", 0.3)
let s:guiDiffText = s:mixcolors("161b1d", "d22d72", 0.2)
