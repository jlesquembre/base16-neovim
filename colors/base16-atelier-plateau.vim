...
let s:guiDiffAdd = s:mixcolors("1b1818", "4b8b8b", 0.3)
let s:guiDiffDelete = s:mixcolors("1b1818", "ca4949")
let s:guiDiffChange = s:mixcolors("1b1818", "7272ca", 0.3)
let s:guiDiffText = s:mixcolors("1b1818", "ca4949", 0.2)
