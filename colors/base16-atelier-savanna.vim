...
let s:guiDiffAdd = s:mixcolors("171c19", "489963", 0.3)
let s:guiDiffDelete = s:mixcolors("171c19", "b16139")
let s:guiDiffChange = s:mixcolors("171c19", "478c90", 0.3)
let s:guiDiffText = s:mixcolors("171c19", "b16139", 0.2)
