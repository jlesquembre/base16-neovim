...
let s:guiDiffAdd = s:mixcolors("131513", "29a329", 0.3)
let s:guiDiffDelete = s:mixcolors("131513", "e6193c")
let s:guiDiffChange = s:mixcolors("131513", "3d62f5", 0.3)
let s:guiDiffText = s:mixcolors("131513", "e6193c", 0.2)
