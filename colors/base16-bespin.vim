...
let s:guiDiffAdd = s:mixcolors("28211c", "54be0d", 0.3)
let s:guiDiffDelete = s:mixcolors("28211c", "cf6a4c")
let s:guiDiffChange = s:mixcolors("28211c", "5ea6ea", 0.3)
let s:guiDiffText = s:mixcolors("28211c", "cf6a4c", 0.2)
