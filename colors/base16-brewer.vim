...
let s:guiDiffAdd = s:mixcolors("0c0d0e", "31a354", 0.3)
let s:guiDiffDelete = s:mixcolors("0c0d0e", "e31a1c")
let s:guiDiffChange = s:mixcolors("0c0d0e", "3182bd", 0.3)
let s:guiDiffText = s:mixcolors("0c0d0e", "e31a1c", 0.2)
