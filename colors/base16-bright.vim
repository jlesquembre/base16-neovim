...
let s:guiDiffAdd = s:mixcolors("000000", "a1c659", 0.3)
let s:guiDiffDelete = s:mixcolors("000000", "fb0120")
let s:guiDiffChange = s:mixcolors("000000", "6fb3d2", 0.3)
let s:guiDiffText = s:mixcolors("000000", "fb0120", 0.2)
