...
let s:guiDiffAdd = s:mixcolors("151515", "acc267", 0.3)
let s:guiDiffDelete = s:mixcolors("151515", "fb9fb1")
let s:guiDiffChange = s:mixcolors("151515", "6fc2ef", 0.3)
let s:guiDiffText = s:mixcolors("151515", "fb9fb1", 0.2)
