...
let s:guiDiffAdd = s:mixcolors("232c31", "237986", 0.3)
let s:guiDiffDelete = s:mixcolors("232c31", "2a5491")
let s:guiDiffChange = s:mixcolors("232c31", "484d79", 0.3)
let s:guiDiffText = s:mixcolors("232c31", "2a5491", 0.2)
