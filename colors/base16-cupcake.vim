...
let s:guiDiffAdd = s:mixcolors("fbf1f2", "A3B367", 0.3)
let s:guiDiffDelete = s:mixcolors("fbf1f2", "D57E85")
let s:guiDiffChange = s:mixcolors("fbf1f2", "7297B9", 0.3)
let s:guiDiffText = s:mixcolors("fbf1f2", "D57E85", 0.2)
