...
let s:guiDiffAdd = s:mixcolors("1D2021", "95C085", 0.3)
let s:guiDiffDelete = s:mixcolors("1D2021", "FB543F")
let s:guiDiffChange = s:mixcolors("1D2021", "0D6678", 0.3)
let s:guiDiffText = s:mixcolors("1D2021", "FB543F", 0.2)
