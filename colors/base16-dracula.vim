...
let s:guiDiffAdd = s:mixcolors("282936", "ebff87", 0.3)
let s:guiDiffDelete = s:mixcolors("282936", "ea51b2")
let s:guiDiffChange = s:mixcolors("282936", "62d6e8", 0.3)
let s:guiDiffText = s:mixcolors("282936", "ea51b2", 0.2)
