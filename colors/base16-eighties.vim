...
let s:guiDiffAdd = s:mixcolors("2d2d2d", "99cc99", 0.3)
let s:guiDiffDelete = s:mixcolors("2d2d2d", "f2777a")
let s:guiDiffChange = s:mixcolors("2d2d2d", "6699cc", 0.3)
let s:guiDiffText = s:mixcolors("2d2d2d", "f2777a", 0.2)
