...
let s:guiDiffAdd = s:mixcolors("16130F", "57826D", 0.3)
let s:guiDiffDelete = s:mixcolors("16130F", "826D57")
let s:guiDiffChange = s:mixcolors("16130F", "6D5782", 0.3)
let s:guiDiffText = s:mixcolors("16130F", "826D57", 0.2)
