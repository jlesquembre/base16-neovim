...
let s:guiDiffAdd = s:mixcolors("2C3E50", "2ECC71", 0.3)
let s:guiDiffDelete = s:mixcolors("2C3E50", "E74C3C")
let s:guiDiffChange = s:mixcolors("2C3E50", "3498DB", 0.3)
let s:guiDiffText = s:mixcolors("2C3E50", "E74C3C", 0.2)
