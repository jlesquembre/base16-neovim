...
let s:guiDiffAdd = s:mixcolors("ffffff", "183691", 0.3)
let s:guiDiffDelete = s:mixcolors("ffffff", "ed6a43")
let s:guiDiffChange = s:mixcolors("ffffff", "795da3", 0.3)
let s:guiDiffText = s:mixcolors("ffffff", "ed6a43", 0.2)
