...
let s:guiDiffAdd = s:mixcolors("1d1f21", "198844", 0.3)
let s:guiDiffDelete = s:mixcolors("1d1f21", "CC342B")
let s:guiDiffChange = s:mixcolors("1d1f21", "3971ED", 0.3)
let s:guiDiffText = s:mixcolors("1d1f21", "CC342B", 0.2)
