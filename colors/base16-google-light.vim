...
let s:guiDiffAdd = s:mixcolors("ffffff", "198844", 0.3)
let s:guiDiffDelete = s:mixcolors("ffffff", "CC342B")
let s:guiDiffChange = s:mixcolors("ffffff", "3971ED", 0.3)
let s:guiDiffText = s:mixcolors("ffffff", "CC342B", 0.2)
