...
let s:guiDiffAdd = s:mixcolors("001100", "00bb00", 0.3)
let s:guiDiffDelete = s:mixcolors("001100", "007700")
let s:guiDiffChange = s:mixcolors("001100", "009900", 0.3)
let s:guiDiffText = s:mixcolors("001100", "007700", 0.2)
