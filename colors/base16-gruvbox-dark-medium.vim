...
let s:guiDiffAdd = s:mixcolors("282828", "b8bb26", 0.3)
let s:guiDiffDelete = s:mixcolors("282828", "fb4934")
let s:guiDiffChange = s:mixcolors("282828", "83a598", 0.3)
let s:guiDiffText = s:mixcolors("282828", "fb4934", 0.2)
