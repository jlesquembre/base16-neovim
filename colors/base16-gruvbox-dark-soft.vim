...
let s:guiDiffAdd = s:mixcolors("32302f", "b8bb26", 0.3)
let s:guiDiffDelete = s:mixcolors("32302f", "fb4934")
let s:guiDiffChange = s:mixcolors("32302f", "83a598", 0.3)
let s:guiDiffText = s:mixcolors("32302f", "fb4934", 0.2)
