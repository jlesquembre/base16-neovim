...
let s:guiDiffAdd = s:mixcolors("f9f5d7", "79740e", 0.3)
let s:guiDiffDelete = s:mixcolors("f9f5d7", "9d0006")
let s:guiDiffChange = s:mixcolors("f9f5d7", "076678", 0.3)
let s:guiDiffText = s:mixcolors("f9f5d7", "9d0006", 0.2)
