...
let s:guiDiffAdd = s:mixcolors("f2e5bc", "79740e", 0.3)
let s:guiDiffDelete = s:mixcolors("f2e5bc", "9d0006")
let s:guiDiffChange = s:mixcolors("f2e5bc", "076678", 0.3)
let s:guiDiffText = s:mixcolors("f2e5bc", "9d0006", 0.2)
