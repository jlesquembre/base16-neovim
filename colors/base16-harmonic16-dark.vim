...
let s:guiDiffAdd = s:mixcolors("0b1c2c", "56bf8b", 0.3)
let s:guiDiffDelete = s:mixcolors("0b1c2c", "bf8b56")
let s:guiDiffChange = s:mixcolors("0b1c2c", "8b56bf", 0.3)
let s:guiDiffText = s:mixcolors("0b1c2c", "bf8b56", 0.2)
