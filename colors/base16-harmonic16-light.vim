...
let s:guiDiffAdd = s:mixcolors("f7f9fb", "56bf8b", 0.3)
let s:guiDiffDelete = s:mixcolors("f7f9fb", "bf8b56")
let s:guiDiffChange = s:mixcolors("f7f9fb", "8b56bf", 0.3)
let s:guiDiffText = s:mixcolors("f7f9fb", "bf8b56", 0.2)
