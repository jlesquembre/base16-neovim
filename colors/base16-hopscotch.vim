...
let s:guiDiffAdd = s:mixcolors("322931", "8fc13e", 0.3)
let s:guiDiffDelete = s:mixcolors("322931", "dd464c")
let s:guiDiffChange = s:mixcolors("322931", "1290bf", 0.3)
let s:guiDiffText = s:mixcolors("322931", "dd464c", 0.2)
