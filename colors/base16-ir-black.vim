...
let s:guiDiffAdd = s:mixcolors("000000", "a8ff60", 0.3)
let s:guiDiffDelete = s:mixcolors("000000", "ff6c60")
let s:guiDiffChange = s:mixcolors("000000", "96cbfe", 0.3)
let s:guiDiffText = s:mixcolors("000000", "ff6c60", 0.2)
