...
let s:guiDiffAdd = s:mixcolors("000000", "33ff00", 0.3)
let s:guiDiffDelete = s:mixcolors("000000", "ff0000")
let s:guiDiffChange = s:mixcolors("000000", "0066ff", 0.3)
let s:guiDiffText = s:mixcolors("000000", "ff0000", 0.2)
