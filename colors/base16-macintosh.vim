...
let s:guiDiffAdd = s:mixcolors("000000", "1fb714", 0.3)
let s:guiDiffDelete = s:mixcolors("000000", "dd0907")
let s:guiDiffChange = s:mixcolors("000000", "0000d3", 0.3)
let s:guiDiffText = s:mixcolors("000000", "dd0907", 0.2)
