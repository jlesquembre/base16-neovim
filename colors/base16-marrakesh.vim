...
let s:guiDiffAdd = s:mixcolors("201602", "18974e", 0.3)
let s:guiDiffDelete = s:mixcolors("201602", "c35359")
let s:guiDiffChange = s:mixcolors("201602", "477ca1", 0.3)
let s:guiDiffText = s:mixcolors("201602", "c35359", 0.2)
