...
let s:guiDiffAdd = s:mixcolors("263238", "8BD649", 0.3)
let s:guiDiffDelete = s:mixcolors("263238", "EC5F67")
let s:guiDiffChange = s:mixcolors("263238", "89DDFF", 0.3)
let s:guiDiffText = s:mixcolors("263238", "EC5F67", 0.2)
