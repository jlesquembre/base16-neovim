...
let s:guiDiffAdd = s:mixcolors("272822", "a6e22e", 0.3)
let s:guiDiffDelete = s:mixcolors("272822", "f92672")
let s:guiDiffChange = s:mixcolors("272822", "66d9ef", 0.3)
let s:guiDiffText = s:mixcolors("272822", "f92672", 0.2)
