...
let s:guiDiffAdd = s:mixcolors("2b303b", "a3be8c", 0.3)
let s:guiDiffDelete = s:mixcolors("2b303b", "bf616a")
let s:guiDiffChange = s:mixcolors("2b303b", "8fa1b3", 0.3)
let s:guiDiffText = s:mixcolors("2b303b", "bf616a", 0.2)
