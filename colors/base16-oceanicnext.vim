...
let s:guiDiffAdd = s:mixcolors("1B2B34", "99C794", 0.3)
let s:guiDiffDelete = s:mixcolors("1B2B34", "EC5f67")
let s:guiDiffChange = s:mixcolors("1B2B34", "6699CC", 0.3)
let s:guiDiffText = s:mixcolors("1B2B34", "EC5f67", 0.2)
