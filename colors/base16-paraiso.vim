...
let s:guiDiffAdd = s:mixcolors("2f1e2e", "48b685", 0.3)
let s:guiDiffDelete = s:mixcolors("2f1e2e", "ef6155")
let s:guiDiffChange = s:mixcolors("2f1e2e", "06b6ef", 0.3)
let s:guiDiffText = s:mixcolors("2f1e2e", "ef6155", 0.2)
