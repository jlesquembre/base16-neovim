...
let s:guiDiffAdd = s:mixcolors("061229", "99bf52", 0.3)
let s:guiDiffDelete = s:mixcolors("061229", "d07346")
let s:guiDiffChange = s:mixcolors("061229", "5299bf", 0.3)
let s:guiDiffText = s:mixcolors("061229", "d07346", 0.2)
