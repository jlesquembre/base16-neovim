...
let s:guiDiffAdd = s:mixcolors("000000", "00e756", 0.3)
let s:guiDiffDelete = s:mixcolors("000000", "ff004d")
let s:guiDiffChange = s:mixcolors("000000", "83769c", 0.3)
let s:guiDiffText = s:mixcolors("000000", "ff004d", 0.2)
