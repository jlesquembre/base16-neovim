...
let s:guiDiffAdd = s:mixcolors("000000", "37b349", 0.3)
let s:guiDiffDelete = s:mixcolors("000000", "eb008a")
let s:guiDiffChange = s:mixcolors("000000", "0e5a94", 0.3)
let s:guiDiffText = s:mixcolors("000000", "eb008a", 0.2)
