...
let s:guiDiffAdd = s:mixcolors("2b2b2b", "a5c261", 0.3)
let s:guiDiffDelete = s:mixcolors("2b2b2b", "da4939")
let s:guiDiffChange = s:mixcolors("2b2b2b", "6d9cbe", 0.3)
let s:guiDiffText = s:mixcolors("2b2b2b", "da4939", 0.2)
