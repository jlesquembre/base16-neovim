...
let s:guiDiffAdd = s:mixcolors("f9f9f9", "0ed839", 0.3)
let s:guiDiffDelete = s:mixcolors("f9f9f9", "e92f2f")
let s:guiDiffChange = s:mixcolors("f9f9f9", "3b48e3", 0.3)
let s:guiDiffText = s:mixcolors("f9f9f9", "e92f2f", 0.2)
