...
let s:guiDiffAdd = s:mixcolors("18262F", "7CC844", 0.3)
let s:guiDiffDelete = s:mixcolors("18262F", "EF5253")
let s:guiDiffChange = s:mixcolors("18262F", "33B5E1", 0.3)
let s:guiDiffText = s:mixcolors("18262F", "EF5253", 0.2)
