...
let s:guiDiffAdd = s:mixcolors("002b36", "859900", 0.3)
let s:guiDiffDelete = s:mixcolors("002b36", "dc322f")
let s:guiDiffChange = s:mixcolors("002b36", "268bd2", 0.3)
let s:guiDiffText = s:mixcolors("002b36", "dc322f", 0.2)
