...
let s:guiDiffAdd = s:mixcolors("fdf6e3", "859900", 0.3)
let s:guiDiffDelete = s:mixcolors("fdf6e3", "dc322f")
let s:guiDiffChange = s:mixcolors("fdf6e3", "268bd2", 0.3)
let s:guiDiffText = s:mixcolors("fdf6e3", "dc322f", 0.2)
