...
let s:guiDiffAdd = s:mixcolors("1f2022", "67b11d", 0.3)
let s:guiDiffDelete = s:mixcolors("1f2022", "f2241f")
let s:guiDiffChange = s:mixcolors("1f2022", "4f97d7", 0.3)
let s:guiDiffText = s:mixcolors("1f2022", "f2241f", 0.2)
