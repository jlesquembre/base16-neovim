...
let s:guiDiffAdd = s:mixcolors("151515", "00C918", 0.3)
let s:guiDiffDelete = s:mixcolors("151515", "FF0086")
let s:guiDiffChange = s:mixcolors("151515", "3777E6", 0.3)
let s:guiDiffText = s:mixcolors("151515", "FF0086", 0.2)
