...
let s:guiDiffAdd = s:mixcolors("FFFFFF", "00C918", 0.3)
let s:guiDiffDelete = s:mixcolors("FFFFFF", "FF0086")
let s:guiDiffChange = s:mixcolors("FFFFFF", "3777E6", 0.3)
let s:guiDiffText = s:mixcolors("FFFFFF", "FF0086", 0.2)
