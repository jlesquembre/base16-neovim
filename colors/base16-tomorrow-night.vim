...
let s:guiDiffAdd = s:mixcolors("1d1f21", "b5bd68", 0.3)
let s:guiDiffDelete = s:mixcolors("1d1f21", "cc6666")
let s:guiDiffChange = s:mixcolors("1d1f21", "81a2be", 0.3)
let s:guiDiffText = s:mixcolors("1d1f21", "cc6666", 0.2)
