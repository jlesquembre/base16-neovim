...
let s:guiDiffAdd = s:mixcolors("ffffff", "718c00", 0.3)
let s:guiDiffDelete = s:mixcolors("ffffff", "c82829")
let s:guiDiffChange = s:mixcolors("ffffff", "4271ae", 0.3)
let s:guiDiffText = s:mixcolors("ffffff", "c82829", 0.2)
