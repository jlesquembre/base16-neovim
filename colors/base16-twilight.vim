...
let s:guiDiffAdd = s:mixcolors("1e1e1e", "8f9d6a", 0.3)
let s:guiDiffDelete = s:mixcolors("1e1e1e", "cf6a4c")
let s:guiDiffChange = s:mixcolors("1e1e1e", "7587a6", 0.3)
let s:guiDiffText = s:mixcolors("1e1e1e", "cf6a4c", 0.2)
