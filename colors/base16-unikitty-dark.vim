...
let s:guiDiffAdd = s:mixcolors("2e2a31", "17ad98", 0.3)
let s:guiDiffDelete = s:mixcolors("2e2a31", "d8137f")
let s:guiDiffChange = s:mixcolors("2e2a31", "796af5", 0.3)
let s:guiDiffText = s:mixcolors("2e2a31", "d8137f", 0.2)
