...
let s:guiDiffAdd = s:mixcolors("ffffff", "17ad98", 0.3)
let s:guiDiffDelete = s:mixcolors("ffffff", "d8137f")
let s:guiDiffChange = s:mixcolors("ffffff", "775dff", 0.3)
let s:guiDiffText = s:mixcolors("ffffff", "d8137f", 0.2)
