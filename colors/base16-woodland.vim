...
let s:guiDiffAdd = s:mixcolors("231e18", "b7ba53", 0.3)
let s:guiDiffDelete = s:mixcolors("231e18", "d35c5c")
let s:guiDiffChange = s:mixcolors("231e18", "88a4d3", 0.3)
let s:guiDiffText = s:mixcolors("231e18", "d35c5c", 0.2)
